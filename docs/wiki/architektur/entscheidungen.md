...
- **Projektlizenz**: Der Routely-eigene Quellcode und die Dokumentation stehen unter Apache-2.0 (Datei `LICENSE`). Drittanbieter-Grafiken, Bibliotheken und Daten behalten ihre eigenen Rechte; insbesondere gelten die nichtkommerziellen Transitous-API-Bedingungen unabhängig von der Codelizenz.
